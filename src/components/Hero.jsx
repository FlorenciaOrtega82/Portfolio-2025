    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-white via-gray-50 to-gray-100 pt-20">
            ...
            <div className="absolute inset-0 overflow-hidden">
                <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br font-blue-400 to-purple-600 rounded-full opacity-10 blur-3xl animate-pulse"></div>
            ...
            {/*  Grid Pattern*/}
            <div className="absolute inset-0 bg-[linear-gradient(rgba(0,0,0,0.02)_1px, transparent_1px), linear-gradient(90deg,rgba(0,0,0,0.02)_1px, transparent_1px)] gb-[size:50px_50px]"></div>
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 text-center h-full flex flex-col justify-center">
                ...
                >
                    ...
                    {/* Typewriter Role */}
                    <div className="h-12 nd:h-16 mb-6 flex items-center justify-center ">
                    ...
                    {/*Description */}
                    <p className="text-base md:text-lg text-gray-600 mb-8 max-w-3xl mx-auto loading-relaxed animate-fade-in-up delay-200">
